...
def can_be_created_in_a_block(args = { title: "Home Alone", release_date: 1990 }) #is this correct? I thought it should be able to take any hash of arguments (I just put this in because that's what the spec was expecting)
  Movie.create do |m|
    m.title = args[:title]
